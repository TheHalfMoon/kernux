...
| --- | --- | --- | --- | --- |
| KX-P00-S01-T01 | NEXT | R1 | Establish pnpm + Cargo monorepo skeleton, canonical folders, root commands, formatting/editor baseline. | plan merge |
| KX-P00-S01-T02 | PLANNED | R1 | Add baseline CI for Rust/TS format, lint, static checks, unit placeholders and cache discipline. | T01 |
| KX-P00-S02-T01 | PLANNED | R1 | Initialize repository-local SpecGrain and document deterministic authoring/refinement workflow. | T01 |
...
| KX-P00-S01-T04 | PLANNED | R1 | Decide/apply project license and validate compatibility strategy for planned donor imports/dependencies. | notices structure |
